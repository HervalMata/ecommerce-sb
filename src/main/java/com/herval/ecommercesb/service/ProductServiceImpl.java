...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductResponse getAllProducts(Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
        ...
        if (productDTOS.isEmpty()) {
            throw new APIException("Nenhum produto cadastrado");
        }
    ...
    public ProductResponse searchByCategory(Long categoryId, Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
        ...
        if (products.isEmpty()) {
            throw new APIException(category.getCategoryName() + "Não tem Nenhum produto cadastrado");
        }
        List<ProductDTO> productDTOS = products.stream()
                .map(product -> modelMapper.map(product, ProductDTO.class)).toList();
    ...
    public ProductResponse searchProductByKeyword(String keyword, Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
        ...
        if (products.isEmpty()) {
            throw new APIException("Não tem Nenhum produto cadastrado com a palavra: " + keyword);
        }
