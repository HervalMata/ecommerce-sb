...
import com.herval.ecommercesb.model.*;
import com.herval.ecommercesb.payload.OrderDTO;
import com.herval.ecommercesb.payload.OrderItemDTO;
import com.herval.ecommercesb.repositories.*;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderDTO placeOrder(String emailId, Long addressId, String paymentMethod, String pgName, String pgPaymentId, String pgStatus, String pgResponseMessage) {
        ...
        if (cart == null) {
            throw new ResourceNotFoundException("Carrinho", "Email",  emailId);
        }
